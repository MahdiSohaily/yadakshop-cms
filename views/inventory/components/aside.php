<!-- Component Start -->
<div class="fixed z-1 min-h-screen flex flex-col items-center w-60  overflow-hidden text-white bg-indigo-600">
    ...
    <a class="flex items-center justify-center w-full h-12 mt-auto bg-gray-600 hover:bg-gray-700 hover:text-gray-300" href="#">
        ...
        <span class="ml-2 text-sm px-2">خروج</span>
    </a>
</div>