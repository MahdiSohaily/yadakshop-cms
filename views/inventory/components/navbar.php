<header class="fixed top-0 left-0 right-0 flex align-center justify-between px-5 h-15 text-white bg-gray-800 shadow-lg">
	...
	S14.224,27,14.5,27z" />
        ...
        <li class="flex items-center relative tooltip_container">
            ...
            <div class="tooltip absolute bg-gray-800 w-52 rounded-b-lg  border border-gray-600 text-white">
                <a href="#" class="relative inline-flex items-center w-full px-4 py-3 text-sm font-normal border-b border-gray- focus:z-10 focus:ring-2  border-gray-600 hover:bg-gray-600 hover:text-white focus:ring-gray-500 focus:text-white">
                    <svg class="w-4 h-4 me-2.5" aria-hidden="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="style=fill">
                            <g id="clock">
                                <path id="Subtract" fill-rule="evenodd" clip-rule="evenodd" d="M12 3.25C6.61779 3.25 2.25 7.61779 2.25 13C2.25 18.3822 6.61779 22.75 12 22.75C17.3822 22.75 21.75 18.3822 21.75 13C21.75 7.61779 17.3822 3.25 12 3.25ZM12.417 8.95911C12.417 8.54489 12.0812 8.20911 11.667 8.20911C11.2528 8.20911 10.917 8.54489 10.917 8.95911V12.6491C10.917 13.0941 11.0674 13.5365 11.2742 13.8993C11.4809 14.2617 11.7844 14.6155 12.1656 14.8417L12.1666 14.8423L14.9546 16.5061C15.3103 16.7184 15.7708 16.6021 15.983 16.2464C16.1953 15.8908 16.079 15.4303 15.7233 15.2181L12.9333 13.5531L12.9313 13.5519C12.827 13.4901 12.6899 13.3537 12.5772 13.1562C12.4646 12.9587 12.417 12.7712 12.417 12.6491V8.95911Z" fill="#fff" />
